...
public class UpdatePute_team extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		t.setTeam_id(Integer.parseInt(request.getParameter("team_id")));
		t.setTeam_text(request.getParameter("team_text"));
		t.setTeam_name(request.getParameter("team_name"));
		t.setTeam_address(request.getParameter("team_address"));
		t.setTeam_phone(request.getParameter("team_phone"));
		try {
