...
<html>
	<head>
		...
		*{
			...
			/* 顶栏设置 */
			body{
				background-image: url("img/注册与登录页面背景bena.webp");
	...
	<body>
		...
		<div class="login_rest">
				...
				<form action="reste" method="post">
				<div class="login_from2">
					<!-- 此处是注册 -->
					<table class="registati">
						<tr>
							<td><input type="text" class="input_txt" placeholder="请输入注册登录名....." name="rest-name"></td>
						</tr>
						<tr>
							<td><input type="password" class="input_txt" placeholder="请输入注册登录密码...." name="rest-pwd"></td>
						</tr>
						<tr>
							<td><input type="password" class="input_txt" placeholder="请确认密码....." name="rest-yzm"></td>
						</tr>
						<tr>
							<td  ><input type="checkbox" name="rest-xzk" checked="checked">&nbsp;<a href="#" style="font-size:12px;" >注册确认用户隐私协议</a></td>
						</tr>
						<tr>
							<td ><input type="submit" value="确认注册" class="btn_res" >&nbsp;&nbsp;<input type="reset" value="内容重置" class="btn"></td>
						</tr>
					</table>
				</div>
				</form>
		...
		<div class="copy_qihang">
			<h5>版权著有启航小组所有2022-2023&copy;<a href="#">使用联系！</a></h5>
		</div>
	</body>
</html>