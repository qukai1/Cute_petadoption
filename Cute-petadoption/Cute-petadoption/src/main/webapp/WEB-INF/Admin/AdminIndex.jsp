      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="Admin_team"><i class="mdi mdi-home"></i> 后台首页</a> </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-palette"></i> 用户管理</a>
              <ul class="nav nav-subnav">
                <li> <a href="User_mode">用户状态</a> </li>
                <li> <a href="Login_user">用户权限</a> </li>
            ...
            <li class="nav-item nav-item-has-subnav">
              ...
              <ul class="nav nav-subnav">
                <li> <a href="Pet_status">宠物状态</a> </li>
            ...
            <li class="nav-item nav-item-has-subnav">
              ...
              <ul class="nav nav-subnav">
                ...
                <li> <a href="lyear_pages_rabc.html">违规申请</a> </li>
           ...
           <div class="card bg-danger">
             <div class="card-body clearfix">
               <div class="pull-right">
                 ...
                 <p class="h3 text-white m-b-0 fa-1-5x">12,000</p>
               </div>
           ...
           <div class="card bg-purple">
             <div class="card-body clearfix">
               <div class="pull-right">
                 ...
                 <p class="h3 text-white m-b-0 fa-1-5x">1153 条</p>
               </div>
		      ...
		      <div class="card-body">
		        <div class="table-responsive">
		          <table class="table table-hover">
		            ...
		            <tbody>
		              <c:forEach items="${allhuodong}" var="v">
		              	<tr>
		                <td>${v.huodong_id}</td>
		                <td>${v.huodong_name}</td>
		                <td>${v.state}</td>
		                <td>${v.eng}</td>
		                <td><span class="label label-warning">${v.houdong_status}</span></td>
		                <td>
		                  <div class="progress progress-striped progress-sm">
		                    <div class="progress-bar progress-bar-warning" style="width:${v.houdong_baifen};"></div>
		                  </div>
		                </td>
		              </tr>
		              </c:forEach>
