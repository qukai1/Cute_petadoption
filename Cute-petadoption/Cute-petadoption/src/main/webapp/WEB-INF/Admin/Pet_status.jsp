        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                <li  class="active"> <a href="Pet_status">宠物状态</a> </li>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>${y.pute_sex}</td>
                      <td><span class="label label-warning" style="background-color:aqua;color:black;">
                      ${y.pute_address}
                      	</span></td>
                      <td>
                      <c:if test="${y.pute_iux==0}">无人领养</c:if>
                      <c:if test="${y.pute_iux!=0}"><span class="label label-warning">有人领养</span></c:if>
                      </td>
                      <td>
                      ${y.pute_date }
                      </td>
