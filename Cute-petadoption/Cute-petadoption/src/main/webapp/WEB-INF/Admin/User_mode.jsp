...
<%@page import="com.pute.Dao.puteDao"%>
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="User_mode">用户状态</a> </li>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>${y.name }</td>
                      <td>
                      	<c:if test="${y.userID==1}">用户</c:if>
                      	<c:if test="${y.userID==2}">管理员</c:if>
                      </td>
                      <td>${y.phone}</td>
